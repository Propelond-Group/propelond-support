...
const features = [
  ...
  },
  {
    ...
    description:
      'Connect with fellow Africans, diaspora members, and global audiences who share your interests.',
    icon: DeviceCardsIcon,
  },
  {
    name: 'Real-time engagement',
    description:
      'Get instant notifications and engage with your audience in real-time conversations.',
    icon: DeviceClockIcon,
  },
  {
    name: 'Grow your network',
    description:
      'Invite friends and family to join Propelond and expand your African community network.',
    icon: DeviceListIcon,
  },
  {
    name: 'Secure and private',
    description:
      'Advanced privacy controls and security features to protect your personal information and content.',
    icon: DeviceLockIcon,
  },
  {
    name: 'Analytics and insights',
    description:
      'Track your content performance and understand your audience with detailed analytics.',
